<template>
  <div>
    ...
    <con>
      <div class="main-top">
        <div style="margin:0 0 16px 0" class="subtit">{{$t('route.addSupplier')}}</div>
        <el-form
          :model="ruleForm"
          :rules="rules"
          ref="ruleForm"
        ...
        >
          ...
          <el-form-item :label="$t('supMana.supplier.description')" size="small" style="width:95%">
...
import { createSupplier, codeGen, getByName } from "@/api/supplier";
