<template>
  <div class="main">
    <div>{{$t('route.editProductionRecord')}}</div>
    <el-form
      :model="ruleForm"
      :rules="rules"
      ref="ruleForm"
    ...
    >
      ...
      <el-form-item :label="$t('productionRecord.unitName')" prop="unitId" size="small">
...
import { getPr, updatePr } from "@/api/productionRecord";
