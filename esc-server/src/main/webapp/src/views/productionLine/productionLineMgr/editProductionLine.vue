<template>
  <div>
    ...
    <con>
      <div class="main-top">
        <div style="margin:0 0 16px 0">编辑产线</div>
        <el-form
          :model="ruleForm"
          :rules="rules"
          ref="ruleForm"
        ...
        >
          ...
          <el-form-item label="手机号码" prop="leaderPhone" size="small">
  ...
  methods: {
    ...
    getProductionLine(id) {
      findAllProductionLineData({
        ...
        if (res.code === "0") {
          this.ruleForm.id = res.data.content[0].id;
          this.ruleForm.name = res.data.content[0].name;
          this.ruleForm.address = res.data.content[0].address;
          this.ruleForm.workshop = res.data.content[0].workshop;
          this.ruleForm.leader = res.data.content[0].leader;
          this.ruleForm.leaderPhone = res.data.content[0].leaderPhone;
          this.ruleForm.warehouse = res.data.content[0].warehouse.id;
          this.ruleForm.chejian=res.data.content[0].chejian.id
        }
      });
    },
  },
